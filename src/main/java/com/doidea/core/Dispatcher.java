...
public class Dispatcher implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
        ...
        try {
            ...
            if (null == loader)
                loader = ClassLoader.getSystemClassLoader().getParent(); // jdk.internal.loader.ClassLoaders$PlatformClassLoader
            ...
            for (IMyTransformer transformer : transformers) {
                ...
                // TODO 额外处理 ASM 在 transform 阶段没有处理的类转换，依附在一个能处理的类后面执行【没有生效！后续再看】
                if (transformer.getTargetClassName().equals("sun.management.VMManagementImpl")) {
                    ...
                    new ExtendTransformer().doExtendTransform(inst);
                }
            }
        } catch (Throwable e) {
